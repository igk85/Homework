// Есть массив 1 состоящий из целых чисел
//Написать программу, котороая создаст и распечатает новый массив 2 на основе массива 1, состоящий только из четных чисел
...
int CountIsEven (int[] elements)
{
    ...
    while (i < size)
    {
        if (elements[i] % 2 == 0) result = result + 1;
        i++;
    }
    return result;
}
